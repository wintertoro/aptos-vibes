module aptos_vibes::voting {
    ...
    /// Get vibe score for a project (upvotes - downvotes)
    #[view]
    public fun get_vibe_score(admin_addr: address, project_id: String): i64 acquires VotingRegistry {
